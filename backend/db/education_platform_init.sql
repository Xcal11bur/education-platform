...
DROP TABLE IF EXISTS `section_material`;
...
INSERT INTO `member` (
  ...
  (1, '13800000011', '$2a$10$K/Bk4X/AoR8SH7nMaOn5JONc3/uax1seUz7s.Pah6EJAUmABVl9da', '学员小王', '王一凡', NULL, 1, '2000-05-18', 1, 'WEB', 0, 0),
  (2, '13800000012', '$2a$10$K/Bk4X/AoR8SH7nMaOn5JONc3/uax1seUz7s.Pah6EJAUmABVl9da', '学员小李', '李欣然', NULL, 2, '2001-09-06', 1, 'WEB', 0, 0);
...
INSERT INTO `course_category` (
  ...
  (1, 0, '企业文化', 1, 1, 1, 1, 1),
  (2, 0, '锐道云', 1, 2, 1, 1, 1),
  (5, 0, '云计算&大数据', 1, 3, 1, 1, 1),
  (6, 0, '人力资源管理', 1, 4, 1, 1, 1),
  (3, 1, '企业价值观', 2, 1, 1, 1, 1),
  (4, 1, '组织协同', 2, 2, 1, 1, 1),
  (7, 2, '云原生基础', 2, 1, 1, 1, 1),
  (8, 2, '平台实战', 2, 2, 1, 1, 1),
...
INSERT INTO `course` (
  ...
  (
    ...
    1,
    3,
    'https://cdn.edu.com/course/culture-guide.jpg',
    '帮助新学员系统了解企业发展历程、核心文化与工作方式。',
    1,
    0.00,
    1,
    1820,
  ...
  (
    ...
    1,
    3,
    'https://cdn.edu.com/course/value-practice.jpg',
    '围绕项目协作、客户服务与执行交付梳理价值观在业务中的应用。',
    1,
    0.00,
    1,
    1650,
  ...
  (
    ...
    1,
    4,
    'https://cdn.edu.com/course/communication.jpg',
    '围绕会议沟通、信息同步和问题反馈建立高效协作机制。',
    1,
    0.00,
    1,
    1498,
  ...
  (
    ...
    1,
    4,
    'https://cdn.edu.com/course/team-collaboration.jpg',
    '覆盖项目启动、角色分工、风险同步与复盘协同等核心场景。',
    2,
    69.00,
    1,
    1360,
  ...
  (
    ...
    2,
    7,
    'https://cdn.edu.com/course/cloud-native.jpg',
    '帮助学员建立云原生技术体系认知，适合作为平台学习起点。',
    1,
    99.00,
    1,
    1288,
  ...
  (
    ...
    2,
    7,
    'https://cdn.edu.com/course/container-practice.jpg',
    '聚焦镜像打包、环境发布和服务巡检等典型工作任务。',
    2,
    129.00,
    1,
    1192,
  ...
  (
    ...
    2,
    8,
    'https://cdn.edu.com/course/platform-delivery.jpg',
    '通过典型案例覆盖需求理解、方案设计、交付验收到运维支持。',
    2,
    149.00,
    1,
    1120,
  ...
  (
    ...
    2,
    8,
    'https://cdn.edu.com/course/ops-standard.jpg',
    '学习告警处理、变更管理、日常巡检与故障复盘等运维规范。',
    2,
    119.00,
    1,
    1036,
  ...
  (
    ...
    5,
    9,
    'https://cdn.edu.com/course/data-analysis.jpg',
    '以业务数据分析为主线，帮助学员建立数据思维与分析框架。',
    1,
    89.00,
    1,
    980,
  ...
  (
    ...
    5,
    9,
    'https://cdn.edu.com/course/dashboard.jpg',
    '结合真实场景构建数据看板，完成从数据处理到结果呈现的闭环。',
    2,
    129.00,
    1,
    924,
  ...
  (
    ...
    5,
    10,
    'https://cdn.edu.com/course/data-governance.jpg',
    '覆盖数据标准、口径统一、质量校验与权限治理等核心议题。',
    2,
    99.00,
    1,
    886,
  ...
  (
    ...
    5,
    10,
    'https://cdn.edu.com/course/data-asset.jpg',
    '从资产目录、治理流程到运营复盘，系统提升数据资产管理能力。',
    2,
    139.00,
    1,
    832,
  ...
  (
    ...
    6,
    11,
    'https://cdn.edu.com/course/onboarding.jpg',
    '围绕制度认知、工作流程和团队协作，帮助学员快速进入工作状态。',
    1,
    0.00,
    1,
    1450,
  ...
  (
    ...
    6,
    11,
    'https://cdn.edu.com/course/growth-map.jpg',
    '结合岗位模型和成长路径，帮助学员识别短板并制定学习计划。',
    1,
    59.00,
    1,
    1186,
  ...
  (
    ...
    6,
    12,
    'https://cdn.edu.com/course/manager-advance.jpg',
    '聚焦目标拆解、团队带教、过程辅导与结果复盘等管理关键动作。',
    2,
    129.00,
    1,
    928,
  ...
  (
    ...
    6,
    12,
    'https://cdn.edu.com/course/performance-coaching.jpg',
    '围绕绩效沟通、目标跟进和正向激励提升团队执行与成长效率。',
    2,
    149.00,
    1,
    874,
